<template>
    <div class="part" :class="position">
      <img :src="selectedPart.src" @click="showPartInfo = !showPartInfo" title="arm" alt=""/>
  ...
  export default {
    props: { parts: { type: Array, required: true }, position: { type: String, required: true, validator(value) { return ['left', 'right', 'top', 'bottom', 'center'].includes(value); } } },
    data() {
